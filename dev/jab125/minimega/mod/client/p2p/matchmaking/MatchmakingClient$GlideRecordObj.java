...
/* 438 */     this.map = map; this.minecraftUUID = minecraftUUID; this.duration = duration; this.score = score; this.legacy4j = legacy4j; this.protocolVersion = protocolVersion; } public Identifier map() { return this.map; } public UUID minecraftUUID() { return this.minecraftUUID; } public Duration duration() { return this.duration; } public Optional<Integer> score() { return this.score; } public boolean legacy4j() { return this.legacy4j; } public int protocolVersion() { return this.protocolVersion; }
/*     */ 
/*     */ }


/* Location:              C:\Users\timos\Downloads\minimega-6.5.32.jar!\dev\jab125\minimega\mod\client\p2p\matchmaking\MatchmakingClient$GlideRecordObj.class
